    ...
    return (
      <>
        ...
        <img
          ...
          className="rightbarPromotionImg"
        />
        <p className="promotionName">MaSac株式会社</p>
      </>
    );
  };
        ...
        <div className="rightbarInfo">
          ...
          <div className="rightbarFollowings">
            <div className="rightbarFollowing">
              ...
              />
              <span className="rightbarFollowingName">MaSac</span>
            </div>
            <div className="rightbarFollowing">
              <img
            ...
            <div className="rightbarFollowing">
              <img
                ...
                className="rightbarFollowingImg"
              />
              <span className="rightbarFollowingName">soto</span>
            </div>
            <div className="rightbarFollowing">
              <img
                ...
                className="rightbarFollowingImg"
              />
              <span className="rightbarFollowingName">teru</span>
            </div>
          </div>
        </div>
      </>
